...
from bubblehub.app.telemetry import control_snapshot
...
def _render() -> Group:
    ...
    return Group(
        Panel(_bars(ram_total, ram_used, "RAM", snapshot["memory_pressure"]), title="BubbleHub Memory"),
        Panel(_bars(vram_total, vram_used, "VRAM", "n/a" if vram_total == 0 else "tracked"), title="BubbleHub GPU"),
